...
{
    private static readonly string _freestylePath = Application.streamingAssetsPath + @"\Songs\Freestyle";
    private static readonly string _challengePath = Application.streamingAssetsPath + @"\Songs\Challenge";
    ...
    static Config()
    {
        ...
        foreach (string file in Directory.GetFiles(_freestylePath))
        {
        ...
        foreach (string file in Directory.GetFiles(_challengePath))
        {
            if (file.EndsWith(".json"))
            {
                string filecontent = File.ReadAllText(file);
